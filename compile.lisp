...
(defun make-vm-remove-priority-here ()
	(with-reg (reg)
		`(,(make-move (make-vm-float (get-default-priority)) reg)
			,(make-vm-set-priority-here reg))))
(defun make-vm-remove-priority (node)
	(with-reg (reg)
		`(,(make-move (make-vm-float (get-default-priority)) reg)
			,(make-vm-set-priority node reg))))
