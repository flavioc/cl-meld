...
(deftuple thread-list (:type-thread (:type-list :type-thread)) :special :thread :compact)
(deftuple other-thread (:type-thread :type-thread :type-int) :special :thread :compact)
(deftuple leader-thread (:type-thread :type-thread) :special :thread :compact)
