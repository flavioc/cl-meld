...
(define-external-function "lremove" '(:type-list :all) '((:type-list :all) :all))
...
(define-external-function "append" '(:type-list :all) '((:type-list :all) (:type-list :all)))
(define-external-function "priority" :type-float '(:type-addr))
(define-external-function "reverse" '(:type-list :all) '((:type-list :all)))
...
(define-external-function "lsort" '(:type-list :all) '((:type-list :all)))
(define-external-function "lremoveduplicates" '(:type-list :all) '((:type-list :all)))
...
(define-external-function "addfloatstructs" '(:type-struct :all) '((:type-struct :all) (:type-struct :all)))
(define-external-function "normalizestruct" '(:type-struct :all) '((:type-struct :all)))
(define-external-function "dampstruct" '(:type-struct :all) '((:type-struct :all) (:type-struct :all) :type-float))
(define-external-function "residualstruct" :type-float '((:type-struct :all) (:type-struct :all)))
(define-external-function "dividestruct" '(:type-struct :all) '((:type-struct :all) (:type-struct :all)))
(define-external-function "convolvestruct" '(:type-struct :all) '((:type-struct :all) (:type-struct :all)))
