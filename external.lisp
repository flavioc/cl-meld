...
(define-external-function "partition_vertical" :type-thread '(:type-int :type-int :type-int :type-int))
(define-external-function "partition_horizontal" :type-thread '(:type-int :type-int :type-int :type-int))
(define-external-function "partition_grid" :type-thread '(:type-int :type-int :type-int :type-int))
...
(define-external-function "fabs" :type-float '(:type-float))                                                                (define-external-function "set_size" :type-int '((:type-set :all)))
(define-external-function "set_exists" :type-bool '((:type-set :all) :all) :poly-p t)
