...
(defun variables-defined (body host)
   (with-ret ret
...
(defun variables-undefined-head (head body host)
   (set-tree-difference (variables-undefined0 head body) (variables-defined body host)))
         ...
         (cond
            ...
            (t
               ...
               (let* ((new-clause-body `(,@subgoals ,@assignments ,@constraints))
                      ...
                      (variables-subgoals (variables-defined new-clause-body to))
